...
export const SearchForm: React.FC = () => {
    ...
    function validateInputs(): boolean {
        ...
        if (!comparisonWithStartDate(startDate) || !comparisonWithStartDate(endDate)) {
            isCurrentDate = false;
            setErrortDate(true);
    ...
    const data: ISearchParams = {
        inn, tonality, limit, startDate, endDate, maxFullness, inBusinessNews, onlyMainRole, onlyWithRiskFactors, includeTechNews, includeAnnouncements, includeDigests
    }
