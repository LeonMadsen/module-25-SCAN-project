...
export const Carousel: React.FC = () => {
    const carouselItems = [
        ...
        {id: 4, title: 'Информация доступна в любое время суток', src: stopwatchIcon},
        {id: 5, title: 'Поиск любых сведений', src: loopIcon},
        {id: 6, title: 'Гарантия Вашей приватности', src: lockIcon},
    ]
